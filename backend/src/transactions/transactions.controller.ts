...
export class TransactionsController {
  ...
  async addDirectCustomer(
    ...
    return this.transactionsService.addDirectCustomer(
      addDirectCustomerDto,
      user,
    );
  }
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Get customers for a specific store (Store/Admin only)",
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Get customers for the current user's store (Store only)",
  })
  @ApiResponse({
    status: 200,
    description: "Store customers retrieved successfully",
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: "Get transactions for a specific customer (Store/Admin only)",
  })
