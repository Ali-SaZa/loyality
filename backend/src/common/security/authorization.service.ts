...
export class AuthorizationService {
  ...
  private async checkStoreAccess(
    ...
    throw new ForbiddenException(
      "دسترسی ممنوع. شما مجوز دسترسی به این فروشگاه را ندارید.",
   ...
   */
  private async checkPromotionAccess(
    user: UserContext,
    resource: ResourceAccess,
  ): Promise<void> {
    // Admin can access everything
   ...
   */
  private async checkPromoCodeAccess(
    user: UserContext,
    resource: ResourceAccess,
  ): Promise<void> {
    // Admin can access everything
  ...
  private async checkAdminAccess(
    ...
    throw new ForbiddenException(
      "دسترسی ممنوع. شما مجوز دسترسی به این منبع مدیریتی را ندارید.",
    ); // translated to Persian
  }
