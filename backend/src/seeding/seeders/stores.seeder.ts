...
export class StoresSeeder extends BaseSeeder<StoreDocument> {
  ...
  protected get data(): any[] {
    ...
    const storeUser1 = this.users.find(user => user.phoneNumber === '09122222222'); // Doris Accessories
    const storeUser2 = this.users.find(user => user.phoneNumber === '09166666666'); // Tehran Mall
    const storeUser3 = this.users.find(user => user.phoneNumber === '09177777777'); // Isfahan Bazaar
    const storeUser4 = this.users.find(user => user.phoneNumber === '09221234567'); // Shiraz Market
    ...
    return [
      ...
      },
      {
        ...
        description: 'Premium shopping mall in Tehran with comprehensive features',
        socialLinks: {
