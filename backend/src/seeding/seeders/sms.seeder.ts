...
export class SmsSeeder extends BaseSeeder<SmsDocument> {
  ...
  protected get data(): any[] {
    ...
    const adminUser = this.users.find(user => user.phoneNumber === '09121111111'); // Admin
    const storeUser = this.users.find(user => user.phoneNumber === '09122222222'); // Store user
    const customer1 = this.users.find(user => user.phoneNumber === '09123333333'); // Customer
    const customer2 = this.users.find(user => user.phoneNumber === '09111111111'); // Ali Ahmadi
    const customer3 = this.users.find(user => user.phoneNumber === '09133333333'); // Reza Mohammadi
