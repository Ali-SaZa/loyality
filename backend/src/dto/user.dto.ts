...
export class CustomerResponseDto {
  ...
  @ApiProperty({
    description: "Error message if customer already exists",
    required: false,
  })
  error?: string;

  @ApiProperty({
    description: "Whether customer is already in this store",
    required: false,
  })
...
export class UserResponseDto {
  ...
  @ApiProperty({
    description: "Store address (for store users)",
    required: false,
  })
  address?: string;

  @ApiProperty({
    description: "Store description (for store users)",
    required: false,
  })
  description?: string;
