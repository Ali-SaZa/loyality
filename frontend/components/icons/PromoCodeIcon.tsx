export default function PromoCodeIcon({ className = "size-6" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <g clipPath="url(#clip0_410_2757)">
        ...
        />
        <path
          d="M12.5 11.5C11.67 11.5 11 10.83 11 10C11 9.17 11.67 8.5 12.5 8.5C13.33 8.5 14 9.17 14 10C14 10.83 13.33 11.5 12.5 11.5Z"
          fill="currentColor"
        />
        <path
