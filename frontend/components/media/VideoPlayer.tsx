...
const VideoPlayer = ({ videoId, className = '', isUrl = false }: { videoId: string; className?: string; isUrl?: boolean }) => {
  ...
  return (
    <div className={`relative rounded-xl shadow-xl max-h-[400px] w-full ${className}`}>
      {!isPlaying && (
