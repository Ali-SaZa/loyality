...
export const PromoCodeRegistrationFormValidation = z.object({
  ...
  promoCode: z
    .string()
    .min(6, "کد پروموشن باید حداقل ۶ کاراکتر باشد")
    .max(12, "کد پروموشن باید حداکثر ۱۲ کاراکتر باشد")
    .regex(/^[A-Z0-9]+$/, "کد پروموشن باید شامل حروف بزرگ انگلیسی و اعداد باشد"),
});
