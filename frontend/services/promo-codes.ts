...
export const promoCodesService = {
  ...
  async getAllPromoCodes(params?: {
    ...
    try {
      ...
      if (params?.promotionId)
        queryParams.append("promotionId", params.promotionId);
      if (params?.filters) {
      ...
      const response = await axiosInstance.get<PromoCodeListResponse>(
        `/promo-codes?${queryParams.toString()}`,
      );
  ...
  async bulkCreatePromoCodes(
    data: BulkCreatePromoCodesRequest,
  ): Promise<PromoCode[]> {
    try {
      const response = await axiosInstance.post<PromoCode[]>(
        "/promo-codes/bulk",
  ...
  async updatePromoCode(
    ...
    try {
      const response = await axiosInstance.patch<PromoCode>(
        `/promo-codes/${id}`,
        data,
      );
      return response.data;
  ...
  async changePromoCodeStatus(
    id: string,
    data: ChangePromoCodeStatusRequest,
  ): Promise<PromoCode> {
    try {
      const response = await axiosInstance.patch<PromoCode>(
  ...
  async validatePromoCode(
    ...
    try {
      const response = await axiosInstance.post<PromoCodeValidationResponse>(
  ...
  async getUserPromoCodes(
    ...
    try {
      ...
      const response = await axiosInstance.get<UserPromoCodesResponse>(
        `/promo-codes/user/${data.phoneNumber}?${queryParams.toString()}`,
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleApiError(error);
  ...
  async getPromoCodeStats(promotionId?: string): Promise<PromoCodeStats> {
    try {
      ...
      const response = await axiosInstance.get<PromoCodeStats>(
        `/promo-codes/stats?${queryParams.toString()}`,
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleApiError(error);
  ...
  async getPromoCodesByPromotion(
    ...
    try {
      ...
      const response = await axiosInstance.get<PromoCodeListResponse>(
        `/promo-codes/promotion/${promotionId}?${queryParams.toString()}`,
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleApiError(error);
