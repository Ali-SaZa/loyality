...
export const promotionsService = {
  ...
  async getPromotionByIdWithCodeCount(
    id: string,
  ): Promise<PromotionWithCodeCount> {
    try {
      const response = await axiosInstance.get<PromotionWithCodeCount>(
        `/promotions/${id}/with-codes`,
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleApiError(error);
  ...
  async updatePromotion(
    ...
    try {
      const response = await axiosInstance.patch<Promotion>(
        `/promotions/${id}`,
        data,
      );
      return response.data;
  ...
  async changePromotionStatus(
    id: string,
    data: ChangePromotionStatusRequest,
  ): Promise<Promotion> {
    try {
      const response = await axiosInstance.patch<Promotion>(
  ...
  async getPromotionStats(storeId?: string): Promise<PromotionStats> {
    try {
      ...
      const response = await axiosInstance.get<PromotionStats>(
        `/promotions/stats?${queryParams.toString()}`,
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleApiError(error);
  ...
  async getPromotionsByStore(
    ...
    try {
      ...
      const response = await axiosInstance.get<PromotionListResponse>(
        `/promotions/store/${storeId}?${queryParams.toString()}`,
      );
      return response.data;
    } catch (error) {
      const errorMessage = handleApiError(error);
...
export const getPromotionByIdWithCodeCount =
  promotionsService.getPromotionByIdWithCodeCount;
