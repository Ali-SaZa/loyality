...
import { ApplyPromoCodeValidation, ApplyPromoCodeData } from '@/validation/promoCode'
...
const ApplyPromoCodePage = () => {
  ...
  const confirmUsePromoCode = async () => {
    ...
    try {
      ...
      // Change promo code status to 'used' - this will automatically create a transaction
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-text-light">جستجو و استفاده از کدهای تخفیف مشتریان</p>
        </div>
      </div>
              ...
              <div className="flex gap-4 items-end">
                <div className="flex-1">
                  <Input
                    ...
                    inputType="tel"
                    iconStart={<UserIcon className="size-5 text-text-light-25" />}
                ...
                <Button
                  ...
                  disabled={!watchedPhoneNumber || watchedPhoneNumber.length !== 11}
                >
                  جستجو
                </Button>
              </div>
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-text-light">
                      <p>مبلغ: {promoCode.promotion?.price?.toLocaleString()} تومان</p>
                      <p>امتیاز: {promoCode.promotion?.points} امتیاز</p>
                      {promoCode.notes && (
                        <p>یادداشت: {promoCode.notes}</p>
                      )}
                    </div>
                  </div>
                  <Button
        ...
        {selectedPromoCode && (
          <div className="p-4 bg-background-50 rounded-lg border border-divider">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-medium text-text-dark">{selectedPromoCode.promotion?.title}</span>
            </div>
            <div className="text-sm text-text-light space-y-1">
              <p>مبلغ: {selectedPromoCode.promotion?.price?.toLocaleString()} تومان</p>
